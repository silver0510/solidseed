...
Application home page: http://localhost:3000 (dev) / https://korella.app (prod)
Application privacy policy: https://korella.app/privacy (prod)
Application terms of service: https://korella.app/terms (prod)
...
http://localhost:3000
http://localhost:3001
https://korella.app (production)
https://www.korella.app (production)

# Authorized redirect URIs:
http://localhost:3000/api/auth/callback/google
http://localhost:3001/api/auth/callback/google
https://korella.app/api/auth/callback/google (production)
https://www.korella.app/api/auth/callback/google (production)
...
2. **Update Redirect URIs**
   - Add: `https://korella.app/api/auth/callback/google`
   - Add: `https://www.korella.app/api/auth/callback/google`
