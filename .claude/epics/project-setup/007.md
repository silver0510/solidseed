...
export class EmailService {
  ...
  private static FROM_NAME = 'SolidSeed CRM';
      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <p>Thank you for signing up for SolidSeed CRM! Please verify your email address by clicking the button below:</p>
            <p>
