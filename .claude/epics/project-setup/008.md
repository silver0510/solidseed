...
# Answer the prompts:
# ? Set up and deploy "~/path/to/SolidSeed"? [Y/n] y
# ? Which scope do you want to deploy to? Your Personal Account
# ? Link to existing project? [y/N] n
# ? What's your project's name? solidseed-crm
...
// vercel.json
{
  ...
  "regions": ["iad1"],
  "env": {
    "NEXT_PUBLIC_APP_URL": "https://solidseed.app"
  },
  "build": {
    "env": {
...
2. Set up custom domain (solidseed.app)
