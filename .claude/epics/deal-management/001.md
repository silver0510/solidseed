...
- [ ] Create migration file with all 5 tables and constraints
- [ ] Add all indexes (including GIN index on deal_data JSONB)
- [ ] Configure RLS policies for user-scoped access
- [ ] Insert seed data for residential_sale and mortgage deal types
