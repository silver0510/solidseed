...
3. **Configure OAuth Consent Screen**
   ...
   - App logo: Upload SolidSeed logo
   - Support email: support@solidseed.app
   - Scopes: email, profile
   - Test users: Add development team emails

4. **Set Authorized Redirect URIs**
   - Development: `http://localhost:3000/api/auth/oauth/google/callback`
   - Staging: `https://staging.solidseed.app/api/auth/oauth/google/callback`
   - Production: `https://app.solidseed.app/api/auth/oauth/google/callback`
...
2. **Configure Redirect URIs**
   ...
   - Redirect URIs:
     ...
     - Staging: `https://staging.solidseed.app/api/auth/oauth/microsoft/callback`
     - Production: `https://app.solidseed.app/api/auth/oauth/microsoft/callback`
...
- [ ] SolidSeed logo and branding assets
