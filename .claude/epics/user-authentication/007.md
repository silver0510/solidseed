...
- [ ] Sender email address verified (noreply@korella.com)
...
5. Verify sender address: noreply@korella.com
6. Obtain API key
...
```html
Subject: Verify your Korella account Hi {{user_name}}, Welcome to Korella! Please verify your email
address to activate your account. [Verify Email Button] {{verification_link}} This link will expire
in 24 hours. If you didn't create a Korella account, please ignore this email. Thanks, The Korella
Team
```
...
```html
Subject: Reset your Korella password Hi {{user_name}}, We received a request to reset your password
for your Korella account. [Reset Password Button] {{reset_link}} This link will expire in 1 hour. If
you didn't request a password reset, please ignore this email or contact support if you have
concerns. Thanks, The Korella Team
```

**3. Password Changed Confirmation**

```html
Subject: Your Korella password was changed Hi {{user_name}}, Your Korella account password was
successfully changed. If you made this change, no further action is needed. If you didn't change
your password, please contact our support team immediately at support@korella.com. Thanks, The
Korella Team
```
...
```html
Subject: Security alert: Your Korella account was locked Hi {{user_name}}, We detected multiple
failed login attempts on your Korella account. To protect your account, we've temporarily locked it
...
any concerns, contact our support team at support@korella.com. Thanks, The Korella Team
```
...
- Branded with Korella logo and colors
