-- Remove "lost" stage from pipeline_stages for both deal types
-- Lost deals will be tracked via status field, not as a pipeline stage

-- Update residential sales deal type (remove lost stage)
UPDATE deal_types
SET pipeline_stages = '[
...
-- Update mortgage loan deal type (remove lost stage)
UPDATE deal_types
SET pipeline_stages = '[
  {"code": "lead", "name": "Lead", "order": 1, "type": "normal"},
