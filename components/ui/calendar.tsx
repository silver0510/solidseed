...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar p-4 [--cell-size:3rem] min-w-[280px] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "has-focus:border-ring has-focus:ring-ring/50 has-focus:ring-[3px] relative rounded-md",
